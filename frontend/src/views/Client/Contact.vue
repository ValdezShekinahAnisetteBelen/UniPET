    ...
    <ul id="menu-primary-menu" class="menu">
      ...
      <div class="bt_bb_column_content">
          <div class="bt_bb_column_content_inner">
              <img src="User/wp-content/uploads/sites/2/2019/11/Pet_Contact.svg" alt="Animal Picture">
          </div>
      </div>
  </div>
    <div class="bt_bb_column col-xxl-6 col-xl-6 bt_bb_vertical_align_middle bt_bb_align_left bt_bb_padding_double bt_bb_animation_fade_in bt_bb_animation_move_left animate bt_bb_shape_inherit animated" data-width="6" data-bt-override-class="{}"><div class="bt_bb_column_content"><div class="bt_bb_column_content_inner"><div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_large" data-bt-override-class="null"></div><header class="bt_bb_headline bt_bb_font_weight_bold bt_bb_dash_none bt_bb_size_huge bt_bb_align_inherit" data-bt-override-class="{}"><h1 class="bt_bb_headline_tag"><span class="bt_bb_headline_content"><span><strong>CONTACT</strong> US</span></span></h1></header><header class="bt_bb_headline bt_bb_font_weight_normal bt_bb_dash_none bt_bb_subheadline bt_bb_size_extrasmall bt_bb_align_inherit btNoHeadline" data-bt-override-class="{}"><div class="bt_bb_headline_subheadline"><br>
  </div></header>
  <div class="bt_bb_separator bt_bb_border_style_none bt_bb_bottom_spacing_medium" data-bt-override-class="null"></div><div class="bt_bb_button bt_bb_color_scheme_6 bt_bb_icon_position_left bt_bb_style_filled bt_bb_size_small bt_bb_width_inline bt_bb_shape_drop bt_bb_target_self bt_bb_align_inherit" style="; --primary-color:#EDCCCD; --secondary-color:#f47932;" data-bt-override-class="{}"></div><div class="bt_bb_button bt_bb_color_scheme_6 bt_bb_icon_position_left bt_bb_style_outline bt_bb_size_small bt_bb_width_inline bt_bb_shape_drop bt_bb_target_self bt_bb_align_inherit" style="; --primary-color:#ffffff; --secondary-color:#f47932;" data-bt-override-class="{}"></div><div class="bt_bb_separator bt_bb_border_style_none bt_bb_top_spacing_large" data-bt-override-class="null"></div></div></div></div></div></div></div></div></div><div class="bt_bb_section_bottom_section_coverage_image"><img src="User/wp-content/uploads/sites/2/2019/08/white_bottom_wave_02.png" alt="bt_bb_section_bottom_section_coverage_image"></div></section>
        </div>
  ...
  <div class="container">
    ...
    <div class="contact-2-page"><section id="new" class="new1">
    <form>
        <h1>Contact Us</h1>
  ...
  export default {
    ...
    async addToCart(product) {
      ...
      <style>
    @import '../../../src/assets/User/css/contact.css';
